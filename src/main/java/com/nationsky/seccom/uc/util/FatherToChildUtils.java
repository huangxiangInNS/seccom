...
/**
 * Created by huangxiang on 15-6-9.
 */
    ...
    */
    public static void fatherToChild (Object father,Object child){
        ...
        for(int i=0;i<ff.length;i++){
            ...
            try {
                Method fm = fatherClass.getMethod("get" + upperHeadChar(f.getName()));
                //方法getDeleteDate
                Object obj=fm.invoke(father);//取出属性值
                Method cm = childClass.getMethod("set" + upperHeadChar(f.getName()), type);
                cm.invoke(child, obj);
